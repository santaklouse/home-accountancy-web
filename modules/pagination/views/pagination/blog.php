...
<p class="pagination">
    ...
    <?php if ($previous_page !== FALSE): ?>
            <div class="prev"><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><span><?php echo __('Previous') ?></span></a></div>
    <?php else: ?>
            <div class="prev"><span><?php echo __('Previous') ?></span></div>
    <?php endif ?>

    <?php if ($next_page !== FALSE): ?>
            <div class="next"><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><span><?php echo __('Next') ?></span></a></div>
    <?php else: ?>
            <div class="next"><span><?php echo __('&nbsp;Next&nbsp;') ?></span></div>
    <?php endif ?> 
    </div>
</p><!-- .pagination -->