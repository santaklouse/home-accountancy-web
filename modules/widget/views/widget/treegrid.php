        ...
        if(isset($configure))
        {
            ...
            if(isset($configure['reset_config']))
            {
                ...
                echo '<a class="tools" href="#" ';
                    ...
                    echo '}, \'', $widget_id, '\');return false;" href="#"><span>X</span></a>';
            }
...
?>
$(function() {
    var grid = init_treegrid_widget(<?php echo json_encode($widget_data, JSON_HEX_TAG); ?>);
    <?php
    if ($load_data) echo 'grid.loadGrid();', PHP_EOL;
    ?>
});
</script>