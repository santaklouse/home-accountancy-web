<?php /* Smarty version 2.6.19, created on 2012-08-29 14:02:37
         compiled from addproject.tpl */ ?>
<div class="block_in_wrapper">
<h2><?php echo $this->_config[0]['vars']['addproject']; ?>
</h2>

	<form novalidate class="main" method="post" action="admin.php?action=addpro" <?php echo 'onsubmit="return validateCompleteForm(this);"'; ?>
 >
	<fieldset>
