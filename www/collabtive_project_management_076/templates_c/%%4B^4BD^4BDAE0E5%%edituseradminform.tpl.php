<?php /* Smarty version 2.6.19, created on 2012-08-29 14:02:01
         compiled from edituseradminform.tpl */ ?>
...
<span>/ <?php echo $this->_tpl_vars['user']['name']; ?>
			...
			<div class="userwrapper">
				<form novalidate class="main" method="post" action="admin.php?action=edituser&amp;id=<?php echo $this->_tpl_vars['user']['ID']; ?>
...
:</label></td>
														<td class="right">
															<input type = "text" name = "company" id = "company" value = "<?php echo $this->_tpl_vars['user']['company']; ?>
" />
														</td>
													</tr>
												</tbody>
...
" /></td>
												...
												<tbody class="color-b">
												<tr>
													<td><label for="rate"><?php echo $this->_config[0]['vars']['rate']; ?>
:</label></td>
													<td class="right"><input type = "text" class="text" value = "<?php echo $this->_tpl_vars['user']['rate']; ?>
...
:</label></td>
												...
												<tbody class="color-b">
													<tr>
														<td><label for="tags"><?php echo $this->_config[0]['vars']['tags']; ?>
:</label></td>
														<td class="right"><input type = "text" name = "tags" id = "tags" realname = "<?php echo $this->_config[0]['vars']['tags']; ?>
" value = "<?php echo $this->_tpl_vars['user']['tags']; ?>
" /></td>
													</tr>
												</tbody>
												...
												<tbody class="color-a">
													<tr>
														<td><label><?php echo $this->_config[0]['vars']['permissions']; ?>
:</label></td>
														<td class="right">
															<select name = "role">
...
" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['ID'] == $this->_tpl_vars['user']['role']['ID']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['roles'][$this->_sections['role']['index']]['name']; ?>
</option>
																<?php endfor; endif; ?>
															</select>
														</td>
