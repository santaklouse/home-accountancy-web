...
<br/><br/>
	<form novalidate class="main" action="managefile.php?action=upload&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
...
:</label>
					<div class="fileinput" >
						<input size = "40" type="file" class = "file"  name="userfile1" id="filer"  realname="<?php echo $this->_config[0]['vars']['file']; ?>
" size="19" onchange = "file.value = this.value;" multiple />
