...
<div class="block_in_wrapper">
	...
	<form novalidate class="main" id = "trackeradd" method = "post" action = "managetimetracker.php?action=add" <?php echo 'onsubmit="return validateCompleteForm(this,\'input_error\');'; ?>
">
	<fieldset>
