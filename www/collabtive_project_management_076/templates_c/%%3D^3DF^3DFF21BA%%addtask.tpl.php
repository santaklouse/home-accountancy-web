<?php /* Smarty version 2.6.19, created on 2012-08-29 14:05:02
         compiled from addtask.tpl */ ?>
<div class="block_in_wrapper">

	<h2><?php echo $this->_config[0]['vars']['addtask']; ?>
</h2>
	<form novalidate name = "addtaskform<?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['ID']; ?>
...
:</label><div class="editor"><textarea name="text" id="text<?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['ID']; ?>
...
" name="tasklist" />
	...
	<div class="row-butn-bottom">
		...
		<button type = "reset" onclick="blindtoggle('form_<?php echo $this->_tpl_vars['lists'][$this->_sections['list']['index']]['ID']; ?>
