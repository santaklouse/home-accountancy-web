...
">
									...
									<?php echo ((is_array($_tmp=$this->_tpl_vars['folders'][$this->_sections['fold']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 14, "...", true) : smarty_modifier_truncate($_tmp, 14, "...", true)); ?>
...
<?php endfor; endif; ?>
<div id = "parentfolder" style = "display:none;"><?php echo $this->_tpl_vars['folderid']; ?>
</div>
<script type = "text/javascript">
	<?php echo '
	parentFolder = $("parentfolder").innerHTML;
			Droppables.add(\'dropDirUp\',{
						onDrop: function(element) {
								//alert(\'managefile.php?action=movefile&id='; ?>
<?php echo $this->_tpl_vars['project']['ID']; ?>
<?php echo '&file=\'+element.id+\'&target=\'+parentFolder);
								change(\'managefile.php?action=movefile&id='; ?>
<?php echo $this->_tpl_vars['project']['ID']; ?>
<?php echo '&file=\'+element.id+\'&target=\'+parentFolder,\'jslog\');
								element.hide();
					}
					});
	'; ?>
