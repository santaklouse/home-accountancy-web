<?php /* Smarty version 2.6.19, created on 2012-08-29 14:41:03
...
<?php endif; ?>
				...
				<h2><?php echo $this->_config[0]['vars']['edittask']; ?>
					...
					<form novalidate class="main" method="post" action="managetask.php?action=edit&amp;tid=<?php echo $this->_tpl_vars['task']['ID']; ?>
