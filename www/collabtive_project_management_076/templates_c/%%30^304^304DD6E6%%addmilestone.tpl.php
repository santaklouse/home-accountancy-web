<?php /* Smarty version 2.6.19, created on 2012-08-29 14:40:20
         compiled from addmilestone.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'addmilestone.tpl', 10, false),)), $this); ?>
...
<?php endif; ?>
			...
			<h2><?php echo $this->_config[0]['vars']['addmilestone']; ?>
				...
				<form novalidate class="main" method="post" action="managemilestone.php?action=add&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
...
:</label>
							<div class="editor">
								<textarea name="desc" id="desc" realname="<?php echo $this->_config[0]['vars']['description']; ?>
