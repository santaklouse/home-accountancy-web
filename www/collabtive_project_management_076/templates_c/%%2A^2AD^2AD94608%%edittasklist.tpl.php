<?php /* Smarty version 2.6.19, created on 2012-08-29 14:41:10
...
<?php endif; ?>
			...
			<h2><?php echo $this->_config[0]['vars']['edittasklist']; ?>
					...
					<form novalidate class="main" method="post" action="managetasklist.php?action=edit&amp;id=<?php echo $this->_tpl_vars['project']['ID']; ?>
&amp;tlid=<?php echo $this->_tpl_vars['tasklist']['ID']; ?>
